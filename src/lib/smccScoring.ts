...
// ─── Reference Hunting Guide (찾아야 할 / 피해야 할 레퍼런스) ──────────

interface ProgramGuide {
  description: string
  goodReferences: string[]
  badReferences: string[]
  recommendedTags: string[]
}

export const PROGRAM_GUIDES: Record<string, ProgramGuide> = {
  daily_coffee_chat: {
    description: '낯선 사람들이 출근 전 짧게 모여 가볍게 대화하는 아침 커피챗 프로그램.',
    goodReferences: [
      '낯선 사람들이 아침에 모여 대화하는 장면',
      '작은 카페 테이블, 4~8명 규모',
      '가벼운 자기소개나 질문 카드',
      '출근 전 짧은 커뮤니티 경험',
      '억지 네트워킹이 아니라 느슨한 연결',
    ],
    badReferences: ['비즈니스 네트워킹', '영업 세미나', '커피 제품 리뷰', '카페 투어만 있는 콘텐츠', '소개팅/헌팅 느낌'],
    recommendedTags: ['아침대화', '커피챗', '느슨한연결', '동네커뮤니티', '출근전루틴'],
  },
  espresso_run: {
    description: '기록 경쟁이 아니라 함께 뛰고 커피를 마시는 소셜 러닝 커뮤니티.',
    goodReferences: [
      '기록 경쟁보다 함께 뛰는 러닝 크루',
      '러닝 후 커피를 마시는 장면',
      '초보자도 들어갈 수 있는 편안한 분위기',
      '동네 루트, 카페, 대화가 함께 보이는 콘텐츠',
    ],
    badReferences: ['마라톤 기록 단축', '운동화 리뷰', '바디프로필/몸매 과시', '과하게 빡센 운동 루틴'],
    recommendedTags: ['모닝런', '러닝후커피', '러닝커뮤니티', '건강한아침', '동네루트'],
  },
  book_dive: {
    description: '말없이 함께 책을 읽는 조용한 아침 독서 모임.',
    goodReferences: [
      '조용히 함께 책을 읽는 모임 장면',
      '카페나 아늑한 공간에서의 독서',
      '책 추천이나 짧은 감상 나눔',
    ...
    badReferences: ['책 리뷰/순위 콘텐츠만', '책 하울/언박싱', '속독 챌린지', '서점 광고성 콘텐츠'],
    recommendedTags: ['아침독서', '북클럽', '조용한루틴', '함께읽기', '독서모임'],
  },
  morning_rave: {
    description: '술 없이 아침에 함께 춤추고 에너지를 나누는 소버 댄스 파티.',
    goodReferences: [
      '술 없이 아침에 춤추는 분위기',
      '커피, 논알콜 음료, DJ, 밝은 자연광',
      '다양한 연령/배경의 사람들이 함께 즐기는 장면',
      '과하게 섹시하거나 클럽 같지 않은 건강한 파티',
    ],
    badReferences: ['나이트클럽', '술/음주 중심', '헌팅/afterparty', '과한 EDM 페스티벌 느낌'],
    recommendedTags: ['모닝레이브', '소버파티', '커피레이브', '아침댄스', '논알콜문화'],
  },
  smcc_talk: {
    description: '낯선 사람들이 참여형으로 대화를 나누는 모던 살롱형 토크.',
    goodReferences: [
      '낯선 사람들이 둘러앉아 대화하는 살롱 분위기',
      '질문 카드나 주제 기반 토크',
      '편안하고 솔직한 분위기의 대화',
      '발표보다 쌍방향 대화 중심',
    ],
    badReferences: ['토론/논쟁 대회', '강연/세일즈 피칭', '정치적 논쟁', '투자자 피칭 콘텐츠'],
    recommendedTags: ['대화살롱', '아침토크', '솔직한대화', '커뮤니티대화', '질문카드'],
  },
  smcc_cinema: {
    description: '아침에 짧은 영화를 함께 보고 이야기 나누는 시네마 모임.',
    goodReferences: [
      '아침/조식과 함께하는 영화 상영',
      '소규모 영화 토론 모임',
      '야외나 아늑한 공간에서의 스크리닝',
    ...
    badReferences: ['박스오피스 순위 콘텐츠', '영화 평론가 시상식 콘텐츠', '팝콘/극장 광고', 'OTT 순위 콘텐츠'],
    recommendedTags: ['아침영화', '시네마모임', '영화토론', '브렉퍼스트시네마', '스크리닝'],
  },
  breakfast: {
    description: '낯선 사람들과 함께 아침 식사를 나누는 브렉퍼스트 모임.',
    goodReferences: [
      '낯선 사람들이 함께 아침을 먹는 장면',
      '소규모 브런치/조식 커뮤니티',
      '편안한 테이블 세팅, 따뜻한 분위기',
      '음식보다 사람과의 시간이 중심',
    ],
    badReferences: ['음식 레시피 콘텐츠만', '맛집 리뷰/광고', '다이어트 칼로리 콘텐츠', '밀프렙 콘텐츠'],
    recommendedTags: ['아침식사모임', '브렉퍼스트', '함께먹는아침', '브런치커뮤니티', '낯선사람과식사'],
  },
  sunrise_meetup: {
    description: '새벽/일출 시간에 야외에서 함께 모이는 선라이즈 밋업.',
    goodReferences: [
      '일출을 함께 보는 사람들',
      '새벽 야외에서의 가벼운 모임',
      '도시나 자연 속 첫 햇살 장면',
    ...
    badReferences: ['혼자 찍는 일출 사진/영상만', '풍경 타임랩스만', '드론 영상만', '캠핑 장비 리뷰'],
    recommendedTags: ['일출모임', '새벽모임', '선라이즈', '아침산책', '첫햇살'],
  },
  travel_trip: {
    description: '커뮤니티가 함께 떠나는 웰니스 중심의 단체 여행.',
    goodReferences: [
      '낯선 사람들이 함께 떠나는 그룹 여행',
      '웰니스/힐링 중심의 여행 콘텐츠',
      '여행지에서의 커뮤니티 활동',
      '관계가 중심이 되는 여행 경험',
    ],
    badReferences: ['솔로 여행 꿀팁만', '항공권 특가 정보', '럭셔리 호텔 리뷰', '여행 쇼핑 가이드'],
    recommendedTags: ['커뮤니티여행', '그룹트립', '웰니스여행', '함께떠나기', '여행커뮤니티'],
  },
  wellness_class: {
    description: '아침 요가/스트레칭/호흡 등 가볍게 몸과 마음을 깨우는 클래스.',
    goodReferences: [
      '아침 야외 요가/스트레칭 장면',
      '호흡 워크숍, 명상 클래스',
      '초보자도 참여 가능한 편안한 분위기',
    ...
    badReferences: ['고강도 운동 콘텐츠', '바디 트랜스포메이션', '식스팩/근육 자랑', '서플리먼트 광고'],
    recommendedTags: ['모닝요가', '브레스워크', '아침스트레칭', '웰니스클래스', '그룹웰니스'],
  },
  global_meetup: {
    description: '외국인/다국적 멤버가 함께하는 인터내셔널 아침 모임.',
    goodReferences: [
      '다양한 국적의 사람들이 함께 모이는 장면',
      '언어 교환, 문화 교류 중심 콘텐츠',
      '편안하고 환영하는 분위기',
      '아침 커피와 함께하는 글로벌 커뮤니티',
    ],
    badReferences: ['영어 과외 광고', '비자/이민 컨설팅 광고', '외국인 대상 데이팅 앱 광고', '쇼핑 가이드'],
    recommendedTags: ['글로벌밋업', '인터내셔널', '언어교환', '문화교류', '다국적커뮤니티'],
  },
  brand_collaboration: {
    description: '브랜드와 함께하는 웰니스 체험형 컬래버레이션 이벤트.',
    goodReferences: [
      '브랜드와 커뮤니티가 함께하는 체험 이벤트',
      '제품보다 경험 중심의 활성화(activation) 콘텐츠',
      '라이프스타일 브랜드와의 자연스러운 협업',
      '참가자 반응/경험이 중심인 콘텐츠',
    ],
    badReferences: ['언박싱/하울 콘텐츠', '할인코드 홍보만', '제휴 마케팅 광고', '판매 퍼널 영상'],
    recommendedTags: ['브랜드협업', '웰니스체험', '브랜드이벤트', '경험형마케팅', '라이프스타일콜라보'],
  },
  community_event: {
    description: '커뮤니티가 함께 모여 축하하고 즐기는 아침 파티/이벤트.',
    goodReferences: [
      '커뮤니티가 함께 모여 축하하는 장면',
      '아침/낮 시간대의 가벼운 파티',
      '동네/로컬 기반의 친근한 분위기',
      '다양한 사람들이 자연스럽게 어울리는 모습',
    ],
    badReferences: ['나이트클럽/술 중심 이벤트', '심야 파티', 'VIP 전용 술자리', '기업 갈라 행사 광고성 콘텐츠'],
    recommendedTags: ['커뮤니티파티', '동네축제', '커뮤니티셀러브레이션', '모닝이벤트', '함께모이기'],
  },
  corporate_wellness: {
    description: '직장인의 아침 루틴과 웰니스를 돕는 기업 웰니스 프로그램.',
    goodReferences: [
      '직장 동료들이 함께하는 아침 웰니스 활동',
      '출근 전/사내 루틴 콘텐츠',
      '워라밸과 회복을 강조하는 분위기',
      '팀 단위의 건강한 아침 문화',
    ],
    badReferences: ['허슬 컬처/과로 자랑', '생산성 해킹 콘텐츠만', '사이드허슬/머니 콘텐츠', '번아웃 미화 콘텐츠'],
    recommendedTags: ['기업웰니스', '직장인루틴', '오피스모닝', '팀웰니스', '워라밸루틴'],
  },
  other: {
    description: '소버 라이프스타일, 도시형 웰니스 등 SMCC 무드와 맞는 그 외 콘텐츠.',
    goodReferences: [
      '소버 라이프스타일, 의식적인 삶 콘텐츠',
      '제3의 공간(third place) 커뮤니티 문화',
      '도시적이고 미니멀한 웰니스 무드',
      '느린 아침, 의도적인 루틴 콘텐츠',
    ],
    badReferences: ['음주/나이트라이프 콘텐츠', '허슬/머니 집착 콘텐츠', '팔로워 해킹/바이럴 전략 콘텐츠만', '자극적 라이프 콘텐츠'],
    recommendedTags: ['소버라이프', '서드플레이스', '도시웰니스', '느린아침', '의식적인삶'],
  },
}
